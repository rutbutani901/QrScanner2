...
import scanner.qrcodescanner.qrcodereader.barcodescanner.barcodereader.databinding.ActivityCreateTextCodeBinding
...
class CreateTextCode : AppCompatActivity() {

    lateinit var binding:ActivityCreateTextCodeBinding
...
//                application.setTheme(R.style.PinkTheme)
        ...
        binding= ActivityCreateTextCodeBinding.inflate(layoutInflater)
    ...
    fun gotoNextScreen(){
        ...
        if(inputText != "")
        {
            ...
            intent.putExtra("barcodeType", 7)//7 is for text, barcodeType
