...
class CreateInHistoryAdapter(val context: Context,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemCreateView {
        return ItemCreateView(ItemHistoryBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
    var longPressed=false
    var count=0
    override fun onBindViewHolder(holder: ItemCreateView, position: Int) {
