...
import scanner.qrcodescanner.qrcodereader.barcodescanner.barcodereader.databinding.ActivityScanResultBinding
...
import scanner.qrcodescanner.qrcodereader.barcodescanner.barcodereader.modelClass.*
...
//                application.setTheme(R.style.PinkTheme)
       ...
       setGradientInStatusBar(this)
        ...
        binding.otherRecycler.isNestedScrollingEnabled=false
//        loadAdaptiveBannerAd()
//        loadNewNativeAd()

        comesFromHistory=intent.hasExtra("barcodeData")
        if (comesFromHistory) {//came form history
...
//                }
        ...
        if(comesFromHistory)//comes from history
        {
            ...
            if(!sharedPref.isDuplicateBarcodeEnable){
                ...
                barcodeListViewModel.doesBarcodesExist(this,barcodeValue).observe(this,
                    androidx.lifecycle.Observer {

                        if (it == null) {
                            if (!calledOneTime) {
                                CoroutineScope(Dispatchers.IO).launch {
                                    barcodeInsertedId = barcodeListViewModel.insert(this@ScanResult, dataModel)
        ...
        connectionLiveData.observe(this, androidx.lifecycle.Observer { isConnected ->
            isConnected?.let {
                if(isConnected){
                    ...
                    binding.adLinearLayout.visibility=View.VISIBLE
//
                    loadNewNativeAd()
                    loadAdaptiveBannerAd()
                    ...
                    binding.scroolview.visibility=View.GONE
        ...
        binding.showCode.setOnClickListener{
            val intent= Intent(this, ScanCodeShowInfoActivity::class.java)
        ...
        if(barcodeValueType==8) //isfrom website
        {
            ...
            binding.titleHolder.visibility=View.VISIBLE
...
//            if(sharedPref.openWebsiteAutomatically)  openWebsite(websiteUrl)
            if(sharedPref.openWebsiteAutomatically)  openUrl(websiteUrl)
            ...
            if(barcodeValue.startsWith("https://www.facebook.com/")){

                isFb(barcodeValue)
//                if(barcodeInsertedId.toInt()!=-1){
//
//                    barcodeValueType=15
//                    barcodeListViewModel.updateBarcodeType(this,barcodeInsertedId.toInt(),15)
//                }
//
...
//                if(barcodeInsertedId.toInt()!=-1){
//                    barcodeValueType=16
//                    barcodeListViewModel.updateBarcodeType(this,barcodeInsertedId.toInt(),16)
//                }
...
//                if(barcodeInsertedId.toInt()!=-1){
//                    barcodeValueType=17
//                    barcodeListViewModel.updateBarcodeType(this,barcodeInsertedId.toInt(),17)
//                }
...
//                if(barcodeInsertedId.toInt()!=-1){
//                    barcodeValueType=18
//                    barcodeListViewModel.updateBarcodeType(this,barcodeInsertedId.toInt(),18)
//                }
...
//                if(barcodeInsertedId.toInt()!=-1){
//                    barcodeValueType=19
//                    barcodeListViewModel.updateBarcodeType(this,barcodeInsertedId.toInt(),19)
//                }
...
//                settingAdapter(funcList,barcodeValue)
        ...
        else if(barcodeValueType==4) //isfrom phone
        {
            ...
            smsPhone=barcodeValue.substringAfter(":")
...
//            settingAdapter(funcList,barcodeValue)
        ...
        else if(barcodeValueType==15){//fb
            isFb(barcodeValue)
        }
        else if(barcodeValueType==16){//ig
            isIg(barcodeValue)
        }
        else if(barcodeValueType==17){//twitter
            isTwi(barcodeValue)
        }
        else if(barcodeValueType==18){//whatsapp
            isWAp(barcodeValue)
        }
        else if(barcodeValueType==19){//viber
            isVb(barcodeValue)
        }
        else{
            binding.productLogo.visibility=View.GONE
...
//            textToSearchOnWeb=barcodeValue
    ...
    fun showMoreFeaturesDialog(buttonView:View){
        ...
        val popupView: View = inflater.inflate(R.layout.more_function, null)
        ...
        popupWindow.showAsDropDown(buttonView, 0, 30,Gravity.NO_GRAVITY)
        ...
        popupView.findViewById<LinearLayout>(R.id.faq).setOnClickListener{
            popupWindow.dismiss()
            val intent=Intent(this@ScanResult, FaqActivity::class.java)
            startActivity(intent)
        }
    }
...
//        notesDialog.inputText.addTextChangedListener(object :TextWatcher{
//            override fun beforeTextChanged(s: CharSequence?, start: Int, count: Int, after: Int) {
//
//            }
//
//            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
//               if(notesDialog.inputText.editableText.toString().length>0){
//                  notesDialog.ok.isSelected=true
//               }else{
//                   notesDialog.ok.isSelected=false
//               }
//            }
//
...
//        })
                    ...
                    object :
                        ...
                        override fun onAdLoaded(adObject: Any?) {
                            if (adObject != null) {
                                ...
                                scanner.qrcodescanner.qrcodereader.barcodescanner.barcodereader.ads.AdHandler.getInstance(this@ScanResult).showNativeAd(
                                    this@ScanResult,
                                    binding.adContainer,
    ...
    fun loadAdaptiveBannerAd() {
        if(!sharedPref.isPremiumPurchased){
            if(scanner.qrcodescanner.qrcodereader.barcodescanner.barcodereader.ads.AdHandler.getInstance(this).isNetworkAvailable(this)){
                scanner.qrcodescanner.qrcodereader.barcodescanner.barcodereader.ads.AdHandler.getInstance(this)
                    .loadAdaptiveBanner(this, binding.bannerLayout,
...
//        binding.otherRecycler.layoutManager = myLinearLayoutManager
        binding.otherRecycler.layoutManager =  LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false)
...
//
//            val intent=Intent(this,OtherSitesActivity::class.java)
//            intent.putExtra("link","https://www.google.com/search?q=$textToSearchOnWeb")
//            startActivity(intent)
//        }
...
//        inflater.inflate(R.menu.scan_result_more_function_menu, menuBuilder)
//        var optionsMenu = MenuPopupHelper(this, menuBuilder, buttonView)
//        optionsMenu.setForceShowIcon(true)
//
//        val wrapper: Context = ContextThemeWrapper(this, R.style.PopupMenuStyle)
//        optionsMenu = MenuPopupHelper(this,wrapper, buttonView)
//
...
//
//
////        val popupMenu = PopupMenu(this, buttonView)
////
////        if(isFav){
////            popupMenu.menuInflater.inflate(R.menu.scan_result_function_remove_fav, popupMenu.getMenu())
////        }else{
////            popupMenu.menuInflater.inflate(R.menu.scan_result_more_function_menu, popupMenu.getMenu())
////        }
////        popupMenu.setOnMenuItemClickListener(object : PopupMenu.OnMenuItemClickListener {
////            override fun onMenuItemClick(item: MenuItem): Boolean {
////
////                item.title?.let{
////                    if(item.title!!.contains(getString(R.string.collect))){
//////                        performFavTask()
////                    }
////                    else if(item.title!!.contains(getString(R.string.note))){
////
//////                        showNotesDialog()
////                    }
////                    else if(item.title!!.contains(getString(R.string.faq))){
////
////                    }
////
////
...
////            this,
////            (popupMenu.menu as MenuBuilder?)!!, buttonView
////        )
